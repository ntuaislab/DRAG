...
Model for Likelihood Maximization.
...
# method `add` is not defined by nn.Module.
# here we use it as the helper method to append a module to the nn.Module.
def add_module(self: nn.Module, module):
